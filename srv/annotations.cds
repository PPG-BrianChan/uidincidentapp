using uidincident_services.incident from './incident_service';

annotate uidincident_services.incident with @odata.draft.enabled : true;

annotate uidincident_services.users with {
    bname   @title : '{i18n>bname}';
    name_text @title : '{i18n>name_text}'
}

annotate uidincident_services.incident with {
    ID          @title : '{i18n>ID}'
                @readonly;
...
annotate uidincident_services.incident with @UI : {
    HeaderInfo          : {
